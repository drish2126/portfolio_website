...
const Contact=()=>{
    ...
    const sendEmail = (e) => {
        ...
        emailjs
          .sendForm('service_j5fb9wc', 'template_ngm69tb', formRef.current, {
            publicKey: 'E589tWngBX99jbdOt',
          })
          .then(
            (result) => {
              setSuccess(true);
        ...
        className="contact" variants={variants} initial="initial" whileInView="animate">
            <motion.div className="textContainer" variants={variants}>
                ...
                <motion.div className="item" variants={variants}>
                    <h2>Mail</h2>
                    <span>drishtigurnani2126@gmail.com</span>
                </motion.div>
                <motion.div className="item" variants={variants}>
                    <h2>Address</h2>
 ...
 fill="#1C274C"/>
                ...
                onSubmit={sendEmail}
                 ...
                 transition={{delay:4,duration:1}}>
                    <input type="text" required placeholder="Name" name="your_name"/>
